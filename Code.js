...
const PROJECT_HEADERS     = ['Project ID', 'Project Name', 'Task', 'Status', 'Priority', 'Due Date', 'Notes', 'Owner', 'Completed On', 'Target Date', 'Phase', 'Sequence', 'Context'];
...
const BILL_HEADERS        = ['Bill', 'Amount', 'Due Day', 'Frequency', 'Category', 'Account', 'Paid', 'Notes', 'Type', 'Budget Entry'];
...
function createSheetTabs(ss) {
  ...
  NOTIF_REGISTRY.forEach(function(n) {
    configDefaults.push(['notif_' + n.key + '_enabled', 'TRUE']);
  });
